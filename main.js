...
// const TRUNSACTION_BUTTON = document.querySelector('#create_transaction');

// TRUNSACTION_BUTTON.addEventListener('click' , CREATE_TRANSACTION) ; 
...
//     // const style = item == 'expenses' ? '' : 'bg-green-50 border-green-300';
//     FORM.className = `fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-blue-50 border-blue-300 border-2 rounded-lg shadow-2xl p-6 w-[90vw] max-w-md z-50`;
//     FORM.innerHTML = `
//                 <div class="flex justify-between items-center mb-6">
//                     <h2 class="text-2xl font-bold text-gray-800">Create transaction </h2>
//                     <button type="button" id='remove_form' class='bg-red-500 hover:bg-red-600 w-8 h-8 rounded-full text-white font-bold flex items-center justify-center cursor-pointer transition duration-200'>×</button>
//                 </div>
...
//                 <select name="" id="" class='mt-1 w-full p-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none'>
//                     ${cards.map(card => `<option value="${card.id}">${card.name}</option>`).join('')}
//                 </select>
...
//                     <button type="submit" class='w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg cursor-pointer transition duration-200 mt-6'>Create</button>
//                 </div>
//             `;
    ...
    FORM.innerHTML = `
                ...
                <div class="space-y-4">
                    ...
                    <label class="block">
                        ...
                        <select name="card_id"  required class="mt-1 w-full p-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer">
...
function LOGIN_FORM() {
    const FORM = document.createElement('form');
    FORM.setAttribute('action', './controllers/user_controller/login.php');
    FORM.setAttribute('method', "POST");
    ...
    FORM.innerHTML = `
        ...
        <div class="space-y-4">
            ...
            <button type="submit" class='w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg cursor-pointer transition duration-200 mt-6'>Login</button>
        </div>
    `;
...
function REGISTER_FORM() {
    const FORM = document.createElement('form');
    FORM.setAttribute('action', 'controllers/user_controller/register.php');
    FORM.setAttribute('method', "POST");
    ...
    FORM.innerHTML = `
        ...
        <div class="space-y-4">
            ...
            <button type="submit" class='w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg cursor-pointer transition duration-200 mt-6'>Register</button>
        </div>
    `;
...
function LOGOUT_CONFIRMATION() {
    const FORM = document.createElement('form');
    FORM.setAttribute('action', './controllers/user_controller/logout.php');
    FORM.setAttribute('method', "POST");
    ...
    FORM.innerHTML = `
        <div class="text-center">
            ...
            <div class="flex gap-3 justify-center">
                <button type="submit" class='bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-lg cursor-pointer transition duration-200'>Logout</button>
                <button type="button" class='bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-6 rounded-lg cursor-pointer transition duration-200' id='remove_form'>Cancel</button>
            </div>
        </div>
    `;
    ...
    FORM.innerHTML = `
        ...
        <div class="space-y-4">
            ...
            <label class="block">
                ...
                <input type="email" name="receiver_email" placeholder="Enter receiver email" required class="mt-1 w-full p-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
            </label>
...
// Event Listeners
CARD_BUTTONS.addEventListener('click' , CREATE_CARD) ;
CATEGORY_BUTTONS.addEventListener('click' , CREATE_CATEGORY) ;


CREATE_INCOME.addEventListener('click', () => CREATE_ITEM('incomes_controller'));
CREATE_EXPENCE.addEventListener('click', () => CREATE_ITEM('expenses_controller'));
